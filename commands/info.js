...
client.guilds.cache.forEach((guild) => {
  ...
  const row = new MessageActionRow()
    ...
    .setLabel("Donate")
    .setStyle("LINK")
    .setURL("https://www.paypal.com/donate/?hosted_button_id=U8793KTL5GUM6")
    .setEmoji('972037997262417960')
      );

  let server = new MessageEmbed()
    .setAuthor({name: "DIGO Giveaway", iconURL: "https://i.ibb.co/4VJB3xY/Tech-With-Zahee-R.png"})
